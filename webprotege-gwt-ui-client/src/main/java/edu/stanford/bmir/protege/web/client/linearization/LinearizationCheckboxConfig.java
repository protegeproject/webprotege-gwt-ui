...
public class LinearizationCheckboxConfig extends CheckBoxConfig {
    ...
    public static String LINEARIZATION_UNKNOWN_TOOLTIP = "Value not set";
    public static String LINEARIZATION_TRUE_TOOLTIP = "True";

    public static String LINEARIZATION_FALSE_TOOLTIP = "False";

    public static String TELESCOPIC_UNKNOWN_TOOLTIP = "Inherited (Value not set)";
    public static String TELESCOPIC_TRUE_TOOLTIP = "Inherited (True)";
    public static String TELESCOPIC_FALSE_TOOLTIP = "Inherited (False)";
    ...
    public static List<CheckboxValue> AVAILABLE_VALUES_LIST = Arrays.asList(new CheckboxValue(UNKNOWN_SVG, "UNKNOWN", LINEARIZATION_UNKNOWN_TOOLTIP),
                                                                             new CheckboxValue(CHECK_SVG, "TRUE", LINEARIZATION_TRUE_TOOLTIP),
                                                                             new CheckboxValue(X_SVG, "FALSE", LINEARIZATION_FALSE_TOOLTIP));


    public LinearizationCheckboxConfig() {
        super(new CheckboxValue(UNKNOWN_SVG, "UNKNOWN", LINEARIZATION_UNKNOWN_TOOLTIP), AVAILABLE_VALUES_LIST);
    }
