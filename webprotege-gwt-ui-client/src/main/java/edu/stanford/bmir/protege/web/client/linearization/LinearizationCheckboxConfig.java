...
public class LinearizationCheckboxConfig extends CheckBoxConfig {
    ...
    public static List<CheckboxValue> AVAILABLE_VALUES_LIST = Arrays.asList(new CheckboxValue(UNKNOWN_SVG, "UNKNOWN", "Value not set"),
                                                                             new CheckboxValue(CHECK_SVG, "TRUE", "True"),
                                                                             new CheckboxValue(X_SVG, "FALSE", "False"));


    public LinearizationCheckboxConfig() {
        super(new CheckboxValue(UNKNOWN_SVG, "UNKNOWN", "Value not set"), AVAILABLE_VALUES_LIST);
    }
