...
public interface Messages extends com.google.gwt.i18n.client.Messages {
    ...
    @DefaultMessage("Equivalent class parents are generated by setting the logical definition super class to an ancestor. " +
            "If the removal of a parent from an equivalent class is required then the logical definition superclasses need to ne changed.")
    @Key("hierarchy.editParents.equivalentClassParent")
    String hierarchy_editParents_equivalentClassParent();
    ...
    @DefaultMessage("Default project tabs")
    @Key("perspective.projectDefault.save.title")
    String perspective_projectDefault_save_title();
    ...
    @Key("settings.projectRoleAssignments.title")
    String settings_projectRoleAssignments();
}
