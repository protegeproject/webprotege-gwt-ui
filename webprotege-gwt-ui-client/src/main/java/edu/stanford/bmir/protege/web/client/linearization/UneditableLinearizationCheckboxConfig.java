...
public class UneditableLinearizationCheckboxConfig extends CheckBoxConfig {
    protected UneditableLinearizationCheckboxConfig() {
    ...
    public static List<CheckboxValue> AVAILABLE_VALUES_LIST = Arrays.asList(new CheckboxValue(DEFAULT_UNKNOWN_SVG, "FOLLOW_BASE_LINEARIZATION_UNKNOWN",  LinearizationCheckboxConfig.TELESCOPIC_UNKNOWN_TOOLTIP),
