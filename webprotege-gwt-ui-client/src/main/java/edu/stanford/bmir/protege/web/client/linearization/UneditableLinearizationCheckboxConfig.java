...
public class UneditableLinearizationCheckboxConfig extends CheckBoxConfig {
    ...
    public static List<CheckboxValue> AVAILABLE_VALUES_LIST = Arrays.asList(new CheckboxValue(DEFAULT_UNKNOWN_SVG, "FOLLOW_BASE_LINEARIZATION_UNKNOWN", "Not set value"),
