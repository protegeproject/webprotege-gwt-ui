...
public class UneditableLinearizationCheckboxConfig extends CheckBoxConfig {
    ...
    public static List<CheckboxValue> AVAILABLE_VALUES_LIST = Arrays.asList(new CheckboxValue(DEFAULT_UNKNOWN_SVG, "FOLLOW_BASE_LINEARIZATION_UNKNOWN", "Value not set (inherited)"),
            new CheckboxValue(DEFAULT_CHECK_SVG, "FOLLOW_BASE_LINEARIZATION_TRUE", "True (inherited)"),
            new CheckboxValue(DEFAULT_NOT_ALLOWED, "FOLLOW_BASE_LINEARIZATION_FALSE", "False (inherited)"));
