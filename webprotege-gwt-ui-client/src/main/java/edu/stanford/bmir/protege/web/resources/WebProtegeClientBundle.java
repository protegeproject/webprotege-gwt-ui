...
public interface WebProtegeClientBundle extends ClientBundle {
    ...
    interface Icd11 extends CssResource {

        @ClassName("ectComponent")
        String ectComponent();
        ...
        String ctwFlexItem75();

        String propertyWrapper();

        String embeddedBrowserSearchbox();

        String flexisearchwarning();

        String entityDetailsCloseiconWrapper();

        String chapterdistributionandfilterdiv();

        String entityDetailsTheCode();

        String chtitlediv();

        String textNotFound();

        String hierarchyNotAvailable();

        String hierarchy();

        String filterSwitchStar();

        String filterSwitchLabel();
        ...
        String tooltipContentPostcoordination();
        ...
        String foundationCodingTool();

        String plcolor();

        String embeddedBrowser();

        String postcoordSearch();

        String postcoordForSelectionLeft();

        String toplevel();

        String found();

        String statusFlexInfo();

        String thecode();

        String statusFlexWords();

        String entityLoading();

        String entityTitlePointerSelection();

        String notleaf();

        String ctwFlexItem50();

        String flexi();

        String tooltipContentKeyboard();

        String propertyHeaderDiagnosticCriteria();

        String showdetails();

        String ulDescendants();

        String markdownDefinition();

        String rtl();

        String advancedsearchdiv();

        String mitHeader();

        String syntaxErrorAlert();

        String entityTheCode();

        String chaptertitle();

        String entityDetailsCodeAndTitle();

        String browsericon();

        String pctitle();

        String postcoordSticky();
        ...
        String entityTheCodeInDetails();

        String entityDetailsContentAfterHead();

        String messageleft();

        String entityPvBadge();

        String empty();

        String postcoordinatedCodeRight();

        String filterWrapper();

        String entityTitleSelection();

        String lastPropertyWrapper();

        String entityDetails();

        String chopped();

        String mandatoryPostcoord();

        String circleicon();

        String ctwFlexItem100();
        ...
        String browserBodyLeft();

        String showlinkSeeInHierarchy();

        String showlinkPostcoordination();
        ...
        String hierarchyResizable();

        String expanded();

        String propertyDiagnosticCriteria();

        String mlcolor();

        String circleiconWithinDetails();

        String nodeWindow();

        String postcoordForSelection();

        String parentcode();

        String popupModeResults();

        String postcoordSearchResult();

        String destinationentitiesdiv();

        String nodeAdoptedChild();

        String tooltipWrapper();

        String browserBodyRightContent();
        ...
        String statusFlexFilter();

        String ch02();

        String advancedsearchIndexTerms();

        String clipboard();

        String tooltipLinkKeyboardOpen();

        String entityTitleSelectionFlex();

        String iconSeeInHierarchy();

        String browserModal();

        String wordlist();

        String postcoorForSelectionURI();
        ...
        String importantlabelCurrentEntityHighlighted();
        ...
        String entityDetailsSelectionHeader();

        @ClassName("ctw-input")
        String ctwInput();

        String defaultErrorAlert();
        ...
        String tooltipCloseiconWrapper();

        String entityTitlePointer();

        String postcoordinatedCodeLeft();

        String closeicon();

        String chdistro();

        String postcoordForSelectionRight();

        String tooltipOpenEndedPostcoordination();

        String codedelimsl();

        String foundpc();

        String propertyHeaderSelection();
        ...
        String orangetextbutton();

        String ch21();

        String ch22();

        String xchaptercodestyle();

        String ch20();

        String browserBodyTitle();

        String postcoordSearchInputToResult();

        String tooltipLinkKeyboard();
        ...
        String propertyHeaderCodingNoteSub();

        String clickinh();

        String postcoordSearchResultList();

        String entityDetailsSelection();

        @ClassName("thecode-11")
        String thecode11();

        String ch18();

        @ClassName("thecode-10")
        String thecode10();
        ...
        String embeddedBrowserAllIndexTerms();
        ...
        String propertyHeaderCodingNote();

        String browserCloseiconWrapper();

        String axis();

        String postcoordCode();

        String browserBodyRight();

        String dontChangeResult();

        String postcoordActionClickable();

        String postcoordFlex();

        String filterSwitch();

        String selected();

        String showlinkNormalSize();

        String postcoordAction();
        ...
        String embeddedBrowserSearch();

        String cncolor();

        String highlightedEntityArrow();

        String nodeResidual();

        String postcoordColored();

        String values();

        String entityDetailsCloseicon();

        String hideNodeWindow();

        String showAllEntities();

        String elementToFadeOut();

        String highlightedParent();

        String dimensionicon();

        String browser();

        String postcoordSearchInput();

        String entityDetailsContent();

        String propertyPostcoordinationSummary();

        String searchresults();

        String ctwFlexItem25();

        String tooltipPostcoordination();

        String propertyHeaderPostcoordination();

        String statusAdvancedsearch();
        ...
        String circleiconWithinDetailsHeaders();

        String stemcodestyle();
