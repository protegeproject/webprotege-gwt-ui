...
public class GenericParameterizedCapabilityTest {
    ...
    public void shouldDeserializeAndSerialize() throws IOException {
        ...
        assertThat(parsed).isEqualTo(GenericParameterizedCapability.get("OtherTypeNotRecognized", CapabilityId.valueOf("PerformActionX"), Map.of("otherProperty", "OtherValue")));
