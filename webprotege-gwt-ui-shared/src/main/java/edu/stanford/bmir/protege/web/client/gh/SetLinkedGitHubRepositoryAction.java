...
public abstract class SetLinkedGitHubRepositoryAction implements ProjectAction<SetLinkedGitHubRepositoryResult> {

    @JsonCreator
    public static SetLinkedGitHubRepositoryAction create(@JsonProperty("projectId") ProjectId projectId,
                                                         @JsonProperty("repositoryCoordinates") GitHubRepositoryCoordinates repositoryCoordinates) {
        return new AutoValue_SetLinkedGitHubRepositoryAction(projectId, repositoryCoordinates);
    }
