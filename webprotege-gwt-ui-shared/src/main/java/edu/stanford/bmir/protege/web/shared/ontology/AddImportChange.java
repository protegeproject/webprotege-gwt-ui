...
public class AddImportChange  implements OntologyChange, Serializable, IsSerializable {

    private OWLOntologyID ontologyId;
    private OWLImportsDeclaration importsDeclaration;


    public AddImportChange(OWLOntologyID ontologyId, OWLImportsDeclaration importsDeclaration) {
