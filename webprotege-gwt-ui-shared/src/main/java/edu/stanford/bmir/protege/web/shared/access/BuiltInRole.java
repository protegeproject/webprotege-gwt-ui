...
public enum BuiltInRole {
    ...
    CAN_VIEW(PROJECT_VIEWER, ISSUE_VIEWER, PROJECT_DOWNLOADER, "View"),

    CAN_COMMENT(CAN_VIEW, ISSUE_CREATOR, OBJECT_COMMENTER, "Comment"),

    CAN_EDIT(PROJECT_EDITOR, CAN_COMMENT, "Edit"),

    CAN_MANAGE(CAN_EDIT, PROJECT_MANAGER, ISSUE_MANAGER, "Manage");
    ...
    BuiltInRole(String label, ImmutableList<BuiltInRole> parents, ImmutableList<BuiltInCapability> actions) {
        this.label = label;
    ...
    BuiltInRole(String label, BuiltInCapability... actions) {
        this(label, ImmutableList.of(), ImmutableList.copyOf(Arrays.asList(actions)));
    }


    BuiltInRole(BuiltInRole parentRole, String label, BuiltInCapability... actions) {
        this(label, ImmutableList.of(parentRole), ImmutableList.copyOf(Arrays.asList(actions)));
    }

    BuiltInRole(BuiltInRole parentRole1, BuiltInRole parentRole2, String label, BuiltInCapability... actions) {
        this(label, ImmutableList.of(parentRole1, parentRole2), ImmutableList.copyOf(Arrays.asList(actions)));
    }

    BuiltInRole(BuiltInRole parentRole1, BuiltInRole parentRole2, BuiltInRole parentRole3, String label, BuiltInCapability... actions) {
        this(label, ImmutableList.of(parentRole1, parentRole2, parentRole3), ImmutableList.copyOf(Arrays.asList(actions)));
    }
    ...
    public ImmutableList<BuiltInCapability> getActions() {
        return actions;
    }
}
